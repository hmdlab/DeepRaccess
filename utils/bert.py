...
sys.path.append(
    "/home/aca10223gf/workplace/tools/ViennaRNA/lib/python3.6/site-packages/"
)
# import RNA
...
class BertForMaskedLM(nn.Module):
    def __init__(self, config, net_bert):
        ...
        self.conv = nn.Conv1d(in_channels=120, out_channels=1, kernel_size=6)
    ...
    def forward(
        ...
        outputs = torch.transpose(encoded_layers, 1, 2)
        outputs = self.bn(self.conv(outputs))
